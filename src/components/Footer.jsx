        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <div className="footer-address">
              ...
              <Link to="/contact" onClick={handleTopNavigation}>
              <h3 className="footer-contact-title">Contact</h3></Link>
            </div>
          </div>

          <div className="footer-links-block">
            <h3>Important Links</h3>
            <Link to="/about" onClick={handleTopNavigation}>About Vikaasa Mall</Link>
